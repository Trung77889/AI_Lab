...
public class Environment {
	...
	public EnvironmentState executeAction(Action action) {
		if(action.equals(MOVE_LEFT) || action.equals(MOVE_RIGHT))
			 envState.setAgentLocation(
					 (envState.getAgentLocation() == Environment.LOCATION_A) 
					 ? Environment.LOCATION_B : Environment.LOCATION_A
			 );
